...
if exist "dist\QuantPredictProEnhanced.exe" (
    ...
    (
        ...
        echo - A-Stock data enhancement
        echo - Volume breakdown display
        echo - Multi-data source support
        echo.
