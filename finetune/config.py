class Config:
    ...
    def __init__(self):
        ...
        import os
        self.dataset_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "data", "processed_datasets"))
        ...
        self.comet_config = {
            ...
            "api_key": "Q1DdjqPOo6QDLidgAIWKoFxTS",
            "project_name": "Kronos-Finetune-Demo",
            "workspace": "xu-liu" # TODO: Change to your Comet ML workspace name
        }
        ...
        """
        self.pretrained_tokenizer_path = "./models/models--NeoQuasar--Kronos-Tokenizer-base"
        self.pretrained_predictor_path = "./models/models--NeoQuasar--Kronos-small"
